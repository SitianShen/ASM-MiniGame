...
;=====================================================
; sst functions
_Init_car proto;–°ÔøΩÔøΩÔøΩÔøΩ ºÔøΩÔøΩ
_Move_process proto;ÊØèÂ∏ßÊõ¥Êñ∞ÈÉΩË¶ÅË∞ÉÁî®ÔºåÂÆûÁé∞ËøûÁª≠ÊÄßÁßªÂä®ÊàñË∑≥Ëµ∑
_Action_left proto;
_Action_right proto;
_Action_jump proto;
_sst_test proto
...
; lja funcions
NextPos proto :ptr BASE         ;√ø∏ˆµ¿æﬂ“∆∂Ø
ChangeAllPos proto      ;±È¿˙À˘”–µ¿æﬂ£¨ π÷Æ“∆∂Ø
;=====================================================
...
;sst
carx0                   equ     150;ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ÷¥ÔøΩÔøΩÔøΩ
carx1                   equ     300
carx2                   equ     450
cary                    equ     500
cary_jump               equ     450
...
.data
target_number   dd      0               ;??????????targets???ÔøΩA???

.data
base_speed      dd      2 ;?????? ??ÔøΩÔøΩ?????
...
_WinMain        proc
        ...
        mov     @stWndClass.hIcon, eax ; ????ÔøΩÔøΩ???
