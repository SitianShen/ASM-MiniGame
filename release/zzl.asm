...
_draw_object proc uses eax ebx ecx edx edi esi, hWnd, hDCGame_ptr, player_addr: ptr Subject, @targets_ptr: ptr Targets, @target_number
        ...
        .if eax == in_begining 
                ...
                .if eax == hWinMain
                        ...
                        invoke  TransparentBlt, hDCGame_ptr, 180, 0, 200, 200, object_DC.titles, 0, 0, PROP_LX, PROP_LY, 16777215
...
;
        ...
        .elseif eax == in_2p_over
                ...
                .else
                        ...
                        mov button_retry.base.posx, 380
                        mov button_retry.base.posy, 420
